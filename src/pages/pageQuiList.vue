...
<template>
  <div id="pageQuiList">
    <qui-list tipsText="Custom text, button on the right" msg="popup"></qui-list>
    <qui-list v-on:btnClickEvent="test"></qui-list>
    <qui-list ref="child1" tipsText="Arrow on the right side" currentView="qui-arrow"></qui-list>
  </div>
</template>
